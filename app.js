...
function main() {
    ...
    function setupObjects(longitude, latitude) {
        ...
        arjs.add(new THREE.Mesh(geom, material), 11.3324033,77.7039629); // slightly north
        arjs.add(new THREE.Mesh(geom, material2), 11.3323641, 77.7046465); // slightly south
...
//     alert(pos.coords.latitude + " f   "+ pos.coords.longitude)
// })
